...
* 8. [src 目录](#src)
	* 8.1. [actions 目录](#actions)
		* 8.1.1. [约定](#-1)
		* 8.1.2. [依赖规则](#-1)
		* 8.1.3. [内部文件夹规则](#-1)
	* 8.2. [assets 目录](#assets)
		* 8.2.1. [约定](#-1)
		* 8.2.2. [依赖规则](#-1)
	* 8.3. [components 目录](#components)
		* 8.3.1. [约定](#-1)
		* 8.3.2. [依赖规则](#-1)
		* 8.3.3. [内部文件夹规则](#-1)
	* 8.4. [containers 目录](#containers)
		* 8.4.1. [依赖规则](#-1)
		* 8.4.2. [内部文件夹规则](#-1)
	* 8.5. [hocs 目录](#hocs)
		* 8.5.1. [依赖规则](#-1)
	...
	* 8.6. [hooks 目录](#hooks)
		...
		* 8.6.2. [命名规则](#-1)
		* 8.6.3. [内部文件夹规则](#-1)
	* 8.7. [packages 目录](#packages)
		* 8.7.1. [约定](#-1)
		* 8.7.2. [依赖规则](#-1)
		* 8.7.3. [内部文件夹规则](#-1)
	* 8.8. [routers 目录](#routers)
		* 8.8.1. [依赖规则](#-1)
		* 8.8.2. [内部文件夹规则](#-1)
	* 8.9. [utils 目录](#utils)
		* 8.9.1. [依赖规则](#-1)
...
2. webpack eslint-loader 环节: 在开发期间, 对不符合代码规范在浏览器中做出错误提示, 如:
   ![](standard/imgs/2019-02-24-20-02-29.png)
...
| 涉及较复杂逻辑的函数                    |  O       |   O       | 减少他人阅读此代码的内部逻辑的时间 |
...
文件夹中的入口文件保持和文件夹名字相同, index.js 仅做引入和导出:
...
###  8.1. <a name='actions'></a>actions 目录
...
####  8.2.2. <a name='-1'></a>依赖规则

不能引入其他文件夹



###  8.3. <a name='components'></a>components 目录
...
###  8.4. <a name='containers'></a>containers 目录
...
如果是通用性的 HOC 组件, 请在 packages 文件夹内创建一个 package
...
####  8.6.3. <a name='-1'></a>内部文件夹规则

此项目内部不可再分文件夹

###  8.7. <a name='packages'></a>packages 目录
...
###  8.8. <a name='routers'></a>routers 目录
...
![](standard/imgs/2019-03-02-17-26-25.png)